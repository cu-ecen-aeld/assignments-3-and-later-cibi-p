...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
  ...
  make ARCH=$ARCH CROSS_COMPILE=$CROSS_COMPILE Image -j12
...
mkdir ${OUTDIR}/rootfs
mkdir ${OUTDIR}/rootfs/bin ${OUTDIR}/rootfs/dev ${OUTDIR}/rootfs/proc \
  ${OUTDIR}/rootfs/sys ${OUTDIR}/rootfs/var ${OUTDIR}/rootfs/tmp \
  ${OUTDIR}/rootfs/etc ${OUTDIR}/rootfs/sbin ${OUTDIR}/rootfs/usr \
...
sudo mknod -m 664 dev/null c 1 3
...
cp writer finder.sh finder-test.sh autorun-qemu.sh conf/ ${OUTDIR}/rootfs/home/ -r
